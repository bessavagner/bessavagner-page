...
heroImage: ../../assets/blog/spec-driven-scaffolding/parse-customize-validate.light.png
heroImageDark: ../../assets/blog/spec-driven-scaffolding/parse-customize-validate.dark.png
tags: ["codegen", "scaffolding", "llm", "cli", "automation"]
status: approved
reviewedAt: 2026-08-05T15:46:59.542Z
reviewHash: sha256:82644cd67483a9b8c4ae6f91f7402796b7dc3e48e23658bf82f79824e56223e1
---
...
- [Anthropic — Tool use](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview): schema-constrained structured output, with `strict: true` for guaranteed conformance.
