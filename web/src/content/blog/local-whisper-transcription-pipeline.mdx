...
<Image src={latency} alt="Transcription latency rises steeply with model size: 1.7s for tiny, 3.8s base, 13.4s small, 32.6s medium, 49.6s large-v3 on a 70-second clip." />
...
<Image src={wer} alt="Word error rate falls from tiny (7.7%) to medium (2.9%) then rises at large-v3 (4.7%): the biggest model scores worse than medium and small." />
