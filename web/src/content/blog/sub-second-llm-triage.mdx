...
heroImageDark: ../../assets/blog/sub-second-llm-triage/cost-per-request.dark.svg
tags: ["llm-agents", "latency", "reliability", "architecture"]
status: approved
reviewedAt: 2026-07-05T08:00:00.000Z
reviewHash: sha256:9238f1bf996ec08b4d6cf6adc70ef261c786ffa92d7bd33f6c955e6e4ab72894
---

import { Image } from 'astro:assets';
import latencyCdf from '../../assets/blog/sub-second-llm-triage/latency-cdf.svg';
import latencyCdfDark from '../../assets/blog/sub-second-llm-triage/latency-cdf.dark.svg';
import costPerRequest from '../../assets/blog/sub-second-llm-triage/cost-per-request.svg';
import costPerRequestDark from '../../assets/blog/sub-second-llm-triage/cost-per-request.dark.svg';
import AnswerBlock from '../../components/blog/AnswerBlock.astro';

<style>{`
  .tri-fig-dark { display: none; }
  [data-theme="custom-dark"] .tri-fig-light { display: none; }
  [data-theme="custom-dark"] .tri-fig-dark { display: block; }
`}</style>
...
<Image src={latencyCdf} alt="CDF of per-request latency on a log scale: gpt-5.4-nano (fast) and gpt-5.4-mini (large) sit almost on top of each other, roughly 1 to 2.6 seconds; the cascade curve trails to the right through the middle of the distribution because escalated turns pay both tiers." class="tri-fig-light" />
<Image src={latencyCdfDark} alt="CDF of per-request latency on a log scale: gpt-5.4-nano (fast) and gpt-5.4-mini (large) sit almost on top of each other, roughly 1 to 2.6 seconds; the cascade curve trails to the right through the middle of the distribution because escalated turns pay both tiers." class="tri-fig-dark" />
...
<Image src={costPerRequest} alt="Bar chart of cost per 1,000 hot-path requests: fast tier (gpt-5.4-nano) $0.21, cascade $0.58, large tier (gpt-5.4-mini) $0.88." class="tri-fig-light" />
<Image src={costPerRequestDark} alt="Bar chart of cost per 1,000 hot-path requests: fast tier (gpt-5.4-nano) $0.21, cascade $0.58, large tier (gpt-5.4-mini) $0.88." class="tri-fig-dark" />
